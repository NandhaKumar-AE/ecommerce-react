...
function App(){
    ...
    return(
        <div className="bg">
          <Navbar></Navbar>
           <center><br></br><h2>Majestic Man Blue Shirt</h2><br></br></center> 
...
<Container>
     ...
     <Card>
        <CardImg top width="375px" src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRUi5ukvuhEf7ni5locKzZdhOAhTtUDFUTZ4XRNbLsuuW0nPX3smNAq4in1cX7q7p2RtF64ZHc6xFNk7ur_Pok_ggxT8iWmH9iSLrItvCc&usqp=CAE" alt="Card image cap" height={375} />
      ...
      <Card>
        ...
        <CardBody>
          ...
          <h4><CardTitle>Majestic Man Blue Shirt</CardTitle></h4><br></br>
